...
<head>
    <!-- head Start -->
<?php include 'lib/main/head.php';?>
     <!-- head End -->
</head>

<body>
    <!-- Navbar Start -->
    <?php include 'lib/main/Navbar.php';?>
    <!-- Navbar End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="mb-4">Visite nossos ultimos projetos e conheça nossos produto, entregues com qualidade e segurança.</h1>
            </div>
            <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline mb-5" id="portfolio-flters">
                        <li class="mx-2 active" data-filter="*">Tudo</li>
                        <li class="mx-2" data-filter=".first">Paineis Solares</li>
            ...
            <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.5s">
                <div class="col-lg-4 col-md-6 portfolio-item first">
                    ...
                    <div class="pt-3">
                        <p class="text-primary mb-0">Paineis Solares</p>
        ...
        <div class="container quote px-lg-0">
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <h6 class="text-primary">Orçamento Solar</h6>
                        <h1 class="mb-4">Obtenha seu orçamento.</h1>
                        <p class="mb-4 pb-2">Envie seus dados e sua ultima conta de energia, para que possamos realizar o orçamento de sua obra:</p>
                        <form action="" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="file" class="form-control border-0" placeholder="Arquivo" style="height: 55px;">
                                </div>
                                <div class="col-12">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 class="text-primary">Membros da Equipe</h6>
                <h1 class="mb-4">Membros Experientes da Equipe</h1>
            </div>
            <div class="row g-4">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="mb-4">Vejo o que nosso clientes dizem sobre nós.</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text text-center rounded p-4">
                        ...
                        <span class="fst-italic">Professão</span>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <div class="testimonial-img position-relative">
    ...
    <!-- Footer Start -->
    <?php include 'lib/main/Footer.php';?>
    <!-- Footer End -->
